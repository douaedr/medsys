...
-- ============================================================
-- 1. ms_auth_db - Comptes utilisateurs
-- ============================================================
USE ms_auth_db;
...
-- ============================================================
-- 2. ms_patient_db - Services
-- ============================================================
USE ms_patient_db;

INSERT IGNORE INTO services (nom, code, description, capacite_lits, localisation) VALUES
('Cardiologie', 'CARDIO', 'Service de cardiologie et maladies cardiovasculaires', 30, 'Batiment A - 2eme etage'),
('Urgences', 'URG', 'Service des urgences medicales 24h/24', 50, 'Rez-de-chaussee'),
('Pediatrie', 'PEDIA', 'Service de pediatrie et neonatologie', 25, 'Batiment B - 1er etage'),
('Radiologie', 'RADIO', 'Service de radiologie et imagerie medicale', 20, 'Batiment C - RDC'),
('Chirurgie', 'CHIR', 'Service de chirurgie generale et digestive', 35, 'Batiment A - 3eme etage');
...
('Lamrani', 'Kamal', 'AB789012', '1979-04-23', 'MASCULIN', '0612000027', 'lamrani.k@gmail.com', '32 Rue Al Wifaq', 'Rabat', 'B_POSITIF'),
('Touzani', 'Wafae', 'CD890123', '1990-08-10', 'FEMININ', '0612000028', 'touzani.w@gmail.com', '65 Hay Al Fath', 'Marrakech', 'O_POSITIF'),
('Ennaji', 'Yassine', 'EF901234', '1974-12-27', 'MASCULIN', '0612000029', 'ennaji.y@gmail.com', '98 Rue Moulay Ali', 'Agadir', 'A_POSITIF'),
('Bouzidi', 'Hafida', 'GH012345', '1981-05-14', 'FEMININ', '0612000030', 'bouzidi.h@gmail.com', '20 Bd Roudani', 'Casablanca', 'B_NEGATIF'),
...
-- ============================================================
-- 3. ms_appointment_db - Creneaux et RDV
-- ============================================================
...
(1, '2026-05-08 09:00:00', '2026-05-08 09:30:00', 1),
(1, '2026-05-08 09:30:00', '2026-05-08 10:00:00', 1),
(2, '2026-05-08 08:00:00', '2026-05-08 08:30:00', 1),
(3, '2026-05-09 09:00:00', '2026-05-09 09:30:00', 1),
(4, '2026-05-09 10:00:00', '2026-05-09 10:30:00', 1);
...
with open(r"C:\Users\douae\Desktop\PFA\medsys-fixed\session2.sql", "w", encoding="utf-8", newline="\n") as f:
    f.write(sql)
print("DONE - session2.sql regenere!")
